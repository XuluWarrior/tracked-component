...
//
//     const TestComponent1 = () => useTrackable(() => <div>{store.count1}</div>)
//     const TestComponent2 = () => useTrackable(() => <div>{store.count2}</div>)
//
...
// })
//
// test.skip("cleanup timer should not clean up recently-pended reactions", () => {
...
//
//     const TestComponent1 = () => useTrackable(() => <div>{store.count}</div>)
//
